...
public class main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            HangHoa hangHoa0 = new HangSanhSu("1111", "ly huong", 50000, 50, dateFormat.parse(ngayNhapKho),
                    "Bui Van Thanh That");
            HangHoa hangHoa1 = new HangDienMay("1112", "may lanh", 2000000, 3, 11, 35);
            HangHoa hangHoa2 = new HangThucPham("1113", "thit bo", 100000, 5, dateFormat.parse(ngaySX),
                    dateFormat.parse(ngayHetHan));
            HangHoa hangHoa3 = new HangSanhSu("1114", "chen su", 10000, 3, dateFormat.parse(ngayNhapKho),
                    "Bui Van Thanh That");
            HangHoa hangHoa4 = new HangDienMay("1115", "tu lanh", 4000000, 1, 10, 35);
            HangHoa hangHoa5 = new HangThucPham("1116", "thit nguoi", 50000, 5, dateFormat.parse(ngaySX),
                    dateFormat.parse(ngayHetHan));
            HangHoa hangHoa6 = new HangSanhSu("1117", "to su", 10000, 5, dateFormat.parse(ngayNhapKho),
                    "Bui Van Thanh That");
            HangHoa hangHoa7 = new HangDienMay("1118", "cuc sac", 20000, 5, 10, 35);
            HangHoa hangHoa8 = new HangThucPham("1119", "thit ba roi", 90000, 10, dateFormat.parse(ngaySX),
                    dateFormat.parse(ngayHetHan));
            HangHoa hangHoa9 = new HangSanhSu("1120", "muong su", 20000, 10, dateFormat.parse(ngayNhapKho),
                    "Bui Van Thanh That");
        ...
        do {
            ...
            switch (choose) {
                ...
                case 6:
                    danhSachHangHoa.statistical();
                    break;
                case 7:
                    danhSachHangHoa.arrangeGoods();
                    break;
                case 8:
                    break;
