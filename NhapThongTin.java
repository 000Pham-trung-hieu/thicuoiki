        ...
        switch (choose) {
            case 1:
                ...
                try {
                    ...
                    hangHoa = new HangSanhSu(commodityCodes, goodsName, price, quantityInStock, dateFormat.parse(date),
                            nhaSX);
            ...
            case 2:
                ...
                hangHoa = new HangDienMay(commodityCodes2, goodsName2, price2, quantityInStock2,
                        thoiGianBaoHanhTheoThang, congSuat);
            ...
            case 3:
                ...
                hangHoa = new HangThucPham(commodityCodes3, goodsName3, price3, quantityInStock3,
                        dateFormat.parse(ngaySX), dateFormat.parse(ngayHetHan));
                break;
            case 4:
                System.out.println("Hen Gap Lai!!!");
                break;
            default:
                System.out.println("Ban Da Lua Chon Sai,Hay Thu Lai!!!");
        }
